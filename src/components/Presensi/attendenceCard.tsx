...
export default function AttendanceCard({ type, onClick, scheduleTime, disabled = false }: AttendanceCardProps) {
  ...
  return (
    ...
    >
      <Card 
        className={`border-l-4 ${borderColor} ${disabled ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer'} bg-[#2a2a2a] border-[#333333]`}
